...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="sticky top-0 z-40 bg-background border-b border-border">
        <div className="flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-4">
            <button className="light:text-gray-700 transition-colors">
              <Search className="size-6" />
            </button>
            <button onClick={handleNotification} className="light:text-gray-700 hover:text-gray-900 transition-colors">
      ...
      {/* Content */}
      <div className="p-2 bg-white dark:bg-black min-h-screen">
        {workouts.length === 0 ? (
            ...
            {showWelcome && (
              <div className="">
                ...
                <div className="pr-8 mt-4">
                  <p className=" text-sm font-regular leading-relaxed mb-4">
                ...
                <div className="flex flex-row items-center gap-6 mt-6">
                  ...
                  <div className="flex flex-col justify-between gap-2 flex-1">
                    <h3 className="text-lg font-semibold light:text-gray-900 w-full">
                      Akash Yadav
                    </h3>
                    <Button
                      variant="default"
