...
// 🔹 NEW: identify from where this page was opened
type AddExerciseSource = "quick-start" | "new-routine";

interface AddExerciseProps {
    source: AddExerciseSource;
}

export default function AddExercisePage({ source }: AddExerciseProps) {
    const router = useRouter();
    const searchParams = useSearchParams();
    const isReplaceMode = searchParams.get("mode") === "replace";
    const isRoutineSource = source === "new-routine";
    ...
    // 🔹 UPDATED: handleAddExercises – branch for routine vs quick-start
    const handleAddExercises = async () => {
        ...
        // 👉 CASE 2: Quick-start flow (existing logic)
        try {
