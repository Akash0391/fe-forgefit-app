      ...
      <div className="p-4 space-y-4 pb-20">
        ...
        <section>
          ...
          <Button
            ...
            variant="outline"
            className="w-full justify-start text-xm bg-gray-100 dark:bg-gray-900 rounded-[10px] p-6"
            size="lg"
          >
        ...
        <section>
          ...
          <div className="flex flex-row gap-2">
            <button
              ...
              className="w-1/2 flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 rounded-[10px] p-6 hover:bg-gray-200 transition-colors cursor-pointer active:scale-95"
            >
                ...
                {expanded && (
                  <div className="space-y-4 mt-2">
                    ...
                    {folderRoutines.length === 0 && (
                      <div className="border border-dashed border-gray-300 dark:border-gray-700 rounded-[10px] p-4 flex items-center justify-center">
                        <button
                          onClick={() =>
              ...
              <div className="space-y-4">
                {myRoutines.map((routine) => {
                  ...
                  return (
                    <div
                      key={routine._id}
                      className="dark:bg-gray-800 rounded-[10px] p-4 shadow-sm border border-gray-100 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow"
                      onClick={handleCardClick}
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
